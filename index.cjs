'use strict';
// Banque Centrale de Mauritanie exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcm';
...
/** Latest rate for one pair, e.g. getRate('USD', 'MRU', { apiKey }). */
